...
RegisterServerEvent('qb-weedplant:processweed')
AddEventHandler('qb-weedplant:processweed', function()
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)

    if Player.Functions.GetItemByName('cannabis') and Player.Functions.GetItemByName('empty_weed_bag') and Player.Functions.GetItemByName('cannabis').amount >=3 then
        ...
        if chance == 1 or chance == 2 or chance == 9 or chance == 4 or chance == 10 or chance == 6 or chance == 7 or chance == 8 then
            Player.Functions.RemoveItem('cannabis', 3)----change this
